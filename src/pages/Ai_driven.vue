  ...
  <div class="project-page" :class="{ 'project-page--maximized': isMaximized }">
    <div class="project-modal" :class="{ 'project-modal--maximized': isMaximized }">
      <div class="project-header"
        ...
        <div class="project-title">AI-Driven Survey System</div>
      ...
      <div class="project-body" :class="{ 'project-body--maximized': isMaximized }">
        <div class="project-card">
          <div class="project-icon-card">
            <img src="../images/csucc.png" alt="Project icon" class="project-icon" />
          </div>
          <div>
        ...
        <div class="section-block">
          ...
          <p class="section-text">
            This system leverages machine learning to automatically interpret user comments and classify them as positive, neutral, or negative. It also features an integrated map that guides clients in locating the appropriate office for their specific needs. Additionally, interactive data visualizations empower administrators with quick, clear access to survey result insights.
          </p>
        </div>
          ...
          <p class="section-text">
            1. Automated Sentiment Analysis: Utilizes machine learning to classify user comments as positive, neutral, or negative, providing immediate insights into respondent feedback.<br><br>
            2. Interactive Data Visualizations: Offers dynamic charts and graphs that allow administrators to explore survey results in depth, identify trends, and make data-driven decisions.<br><br>
            3. Integrated Map Functionality: Features a map interface that helps clients easily locate the appropriate office for their specific needs, enhancing user experience and accessibility.<br><br>
            4. Decision Support System: Provides actionable insights and recommendations based on survey data to assist administrators in improving services and addressing client concerns effectively.
          </p>
        </div>
        ...
        <div class="section-block">
          ...
          <div class="tag-list">
            <span class="tag">XlmRoberTa</span>
        ...
        <div class="section-block">
          ...
          <div class="docs-grid">
            <a class="doc-card" href="https://drive.google.com/file/d/1FJZnP7fwTJnjt75C8wcAGsNo11eFyWs_/view?usp=sharing/preview" target="_blank">
            ...
            <div class="doc-card doc-card-video" style="cursor: pointer;">
              ...
              <div class="doc-copy">
                ...
                <p>Watch a walkthrough of the live survey system with feature highlights.</p>
              </div>
...
.project-body.project-body--maximized {
  max-height: calc(100vh - 57px); /* 57px = project-header height */
  overflow-y: auto;
}
