      ...
      <div class="project-body" :class="{ 'project-body--maximized': isMaximized }">
        <div class="project-card">
          <div class="project-icon-card">
            <img src="../images/line.png" alt="Project icon" class="project-icon" />
          </div>
          <div>
            <h2>School Real-time Queueing System</h2>
        ...
        <div class="status-row">
          ...
          <p class="section-text">
            Students in school offices like the IT/Engineering department and Registrar office often deal with disorganized and chaotic lines — people cutting in, no clear order of service, and long unpredictable waits. There was no fair and transparent system to manage who gets served next, leading to frustration and wasted time for both students and staff.
          </p>
        </div>
        ...
        <div class="section-block">
          ...
          <p class="section-text">
            The system gives each student a queue number when they arrive, then lets them wait without physically standing in line. A real-time display — powered by Reverb broadcasting and Laravel Echo — automatically updates the current number being served, so students always know exactly where they are in the queue. Cashiers and accounting staff call the next number through their dashboard, and the display updates instantly for everyone. An admin manages the overall queuing flow and monitors the system. This eliminates line cutting, brings order to the process, and makes the waiting experience fair and transparent for all students.
          </p>
        </div>
        ...
        <div class="section-block">
          ...
          <p class="section-text">
            1. Digital Queue Management: Students receive a unique queue number upon arrival, eliminating the need to physically stand in line.<br><br>
            2. Real-time Updates: A live display, powered by Reverb broadcasting and Laravel Echo, shows the current number being served, keeping students informed of their position in the queue.<br><br>
            3. Efficient Service: Cashiers and accounting staff call the next number through their dashboard, ensuring a smooth and organized service process.<br><br>
            4. Admin Oversight: An admin panel allows for monitoring and managing the overall queuing flow, ensuring fairness and transparency.
          </p>
        </div>
...
toggleMaximize() {
    ...
    goToSource() {
      window.open('https://github.com/aurjohnmonte/queuing_system', '_blank')
    },
    goToLive() {
