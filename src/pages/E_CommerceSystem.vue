      ...
      <div class="project-body" :class="{ 'project-body--maximized': isMaximized }">
        <div class="project-card">
          <div class="project-icon-card">
            <img src="../images/Logo-3.png" alt="Project icon" class="project-icon" />
          </div>
          <div>
        ...
        <div class="section-block">
          ...
          <p class="section-text">
            Local handmade sellers in Butuan City have no dedicated online platform to showcase their products. This leaves buyers unaware of what's available locally, and with no easy way to find or navigate to their shops.
          </p>
        </div>
        ...
        <div class="section-block">
          ...
          <p class="section-text">
            A local online marketplace for Butuan City where buyers can discover and purchase handmade products from local sellers. Each seller has their own storefront to list and manage their products, while buyers can browse, order, and even use the built-in map to find and navigate to the seller's physical shop. An admin manages the overall platform to keep everything organized and trustworthy.
          </p>
        </div>
        ...
        <div class="section-block">
          ...
          <p class="section-text">
            1. Seller Storefronts: Each local seller has a personalized storefront to list and manage their handmade products, including inventory management and order tracking.<br><br>
            2. Buyer Experience: Buyers can browse through various product categories, search for specific items, and place orders directly through the platform.<br><br>
            3. Integrated Map: A built-in map feature allows buyers to locate sellers' physical shops, providing directions and enhancing the shopping experience.<br><br>
            4. Real-time Order Management: Sellers receive instant notifications of new orders and can update order statuses, while buyers can track their orders in real time.<br><br>
            5. Real-time Chat Support: A chat system enables direct communication between buyers and sellers for inquiries, negotiations, and support.<br><br>
            6. Admin Dashboard: An administrative interface enables platform management, including user oversight, content moderation, and system analytics.
          </p>
        </div>
